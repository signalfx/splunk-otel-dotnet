...
This release include all changes from [1.12.0-beta.1](https://github.com/signalfx/splunk-otel-dotnet/releases/tag/v1.12.0-beta.1)
release.
...
This release is built on top of [OpenTelemetry .NET Auto Instrumentation v1.12.0](https://github.com/open-telemetry/opentelemetry-dotnet-instrumentation/releases/tag/v1.12.0).
...
## [1.10.0](https://github.com/signalfx/splunk-otel-dotnet/releases/tag/v1.10.0)

This release is built on top of [OpenTelemetry .NET Auto Instrumentation v1.11.0](https://github.com/open-telemetry/opentelemetry-dotnet-instrumentation/releases/tag/v1.11.0).
