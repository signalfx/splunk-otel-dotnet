...
if [ "$ENABLE_PROFILING" = "true" ]; then
  ...
  case "$OS_TYPE" in
    ...
    "windows")
      ...
      ;;
    *)
      echo "BUG: Invalid OS_TYPE. Submit an issue in https://github.com/signalfx/splunk-otel-dotnet." >&2
      return 1
      ;;
  esac
  ...
  export OTEL_DOTNET_AUTO_PLUGINS="Splunk.OpenTelemetry.AutoInstrumentation.Plugin, Splunk.OpenTelemetry.AutoInstrumentation, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null"
fi
