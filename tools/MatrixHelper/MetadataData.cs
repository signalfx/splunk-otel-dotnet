...
internal static class MetadataData
{
    public static AllInOne GetAllInOne()
    {
        return new AllInOne(
            ...
            dependencies:
            [
                new("OpenTelemetry .NET", "https://github.com/open-telemetry/opentelemetry-dotnet", null, "1.19.1", "stable"),
                new("OpenTelemetry .NET Automatic Instrumentation", "https://github.com/open-telemetry/opentelemetry-dotnet-instrumentation", null, "1.17.0", "stable")
            ],
