...
internal static class MetadataData
{
    public static AllInOne GetAllInOne()
    {
        return new AllInOne(
            ...
            {
                new("OpenTelemetry .NET", "https://github.com/open-telemetry/opentelemetry-dotnet", null, "1.8.1", "stable"),
                new("OpenTelemetry .NET Automatic Instrumentation", "https://github.com/open-telemetry/opentelemetry-dotnet-instrumentation", null, "1.6.0", "stable"),
            },
