...
internal static class InstrumentationData
{
    public static Instrumentation[] GetInstrumentations()
    {
        ...
        {
            new("ADONET", new InstrumentedComponent("ADO.NET", "`System.Data.Common` (4.0.0 to 11.0.0), `System.Data` for .NET Framework (2.0.0 to 5.0.0), and netstandard (2.0.0 to 3.0.0)"), "Generic ADO.NET instrumentation that covers `DbCommand` methods. It covers only implementations for overridden methods. Typically, a lot of implementations utilize new C# keyword, such cases need specific implementations. What is more this instrumentation does not cover libraries covered by specific instrumentations such as `SQLCLIENT`, `NPGSQL`, `MYSQLDATA`, `MYSQLCONNECTOR`, `ORACLEMDA`, or `SQLITE`", "beta", "third-party", new TracesList()),
