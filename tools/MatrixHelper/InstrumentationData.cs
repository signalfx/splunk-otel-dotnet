...
internal static class InstrumentationData
{
    public static Instrumentation[] GetInstrumentations()
    {
        ...
        {
            new("http.server.duration", histogram, "Duration of the inbound HTTP request, in the form of count, sum, and histogram buckets. This metric originates multiple metric time series, which might result in increased data ingestion costs. Supported only on .NET prior to 8"),
            ...
            new("http.server.request.duration", histogram, "Duration of HTTP server requests. Supported only on .NET8+"),
        ...
        {
            new("http.client.duration", histogram, "Duration of outbound HTTP requests, in the form of count, sum, and histogram buckets. This metric originates multiple metric time series, which might result in increased data ingestion costs.  Supported only on .NET Framework and .NET prior to 8"),
            // following metrics .NET8+ only
            ...
            new("http.client.request.duration", histogram, "Duration of HTTP client requests. Supported only on .NET8+"),
