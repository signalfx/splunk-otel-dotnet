...
internal static class InstrumentationData
{
    public static Instrumentation[] GetInstrumentations()
    {
        ...
        var instrumentations = new Instrumentation[]
        {
            ...
            new("NPGSQL", new InstrumentedComponent("Npgsql", "6.0.0 and higher"), "Metrics are not supported on .NET Framework", "beta", "third-party", new SignalsList[]
            {
                new TracesList(),
                new MetricList(
