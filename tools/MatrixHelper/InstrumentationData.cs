...
internal static class InstrumentationData
{
    public static Instrumentation[] GetInstrumentations()
    {
        ...
        var instrumentations = new Instrumentation[]
        {
            ...
            new(["MONGODB"], [new InstrumentedComponent("MongoDB.Driver.Core", "2.7.0 to 3.0.0"), new InstrumentedComponent("MongoDB.Driver.Core", "3.0.0 to 4.0.0")], "Not supported on .NET Framework", "beta", "third-party", [], [new TracesList()], []), new("MYSQLCONNECTOR", new InstrumentedComponent("MySqlConnector", "2.0.0 and higher"), null, "beta", "third-party", new TracesList()),
