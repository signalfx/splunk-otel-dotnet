...
internal static class InstrumentationData
{
    public static Instrumentation[] GetInstrumentations()
    {
        ...
        {
            new("dotnet.process.cpu.time", counter, "CPU time used by the process. Only available for .NET 9."),
            new("dotnet.process.memory.working_set", upDownCounter, "The number of bytes of physical memory mapped to the process context. Only available for .NET 9."),
            new("dotnet.gc.collections", counter, "The number of garbage collections that have occurred since the process has started. Only available for .NET 9."),
            new("dotnet.gc.heap.total_allocated", counter, "The approximate number of bytes allocated on the managed GC heap since the process started. The returned value does not include any native allocations. Only available for .NET 9."),
            new("dotnet.gc.last_collection.memory.committed_size", upDownCounter, "The amount of committed virtual memory in use by the .NET GC, as observed during the latest garbage collection. Only available for .NET 9."),
            new("dotnet.gc.last_collection.heap.size", upDownCounter, "The managed GC heap size (including fragmentation), as observed during the latest garbage collection. Only available for .NET 9."),
            new("dotnet.gc.last_collection.heap.fragmentation.size", upDownCounter, "The heap fragmentation, as observed during the latest garbage collection. Only available for .NET 9."),
            new("dotnet.gc.pause.time", counter, "The total amount of time paused in GC since the process started. Only available for .NET 9."),
            new("dotnet.jit.compiled_il.size", counter, "Count of bytes of intermediate language that have been compiled since the process started. Only available for .NET 9."),
            new("dotnet.jit.compiled_methods", counter, "The number of times the JIT compiler (re)compiled methods since the process started. Only available for .NET 9."),
            new("dotnet.jit.compilation.time", counter, "The amount of time the JIT compiler has spent compiling methods since the process started. Only available for .NET 9."),
            new("dotnet.thread_pool.thread.count", upDownCounter, "The number of thread pool threads that currently exist. Only available for .NET 9."),
            new("dotnet.thread_pool.work_item.count", counter, "The number of work items that the thread pool has completed since the process started. Only available for .NET 9."),
            new("dotnet.thread_pool.queue.length", upDownCounter, "The number of work items that are currently queued to be processed by the thread pool. Only available for .NET 9."),
            new("dotnet.monitor.lock_contentions", counter, "The number of times there was contention when trying to acquire a monitor lock since the process started. Only available for .NET 9."),
            new("dotnet.timer.count", upDownCounter, "The number of timer instances that are currently active. Only available for .NET 9."),
            new("dotnet.assembly.count", upDownCounter, "The number of .NET assemblies that are currently loaded. Only available for .NET 9."),
            new("dotnet.exceptions", counter, "The number of exceptions that have been thrown in managed code. Only available for .NET 9."),
            new("process.runtime.dotnet.gc.collections.count", counter, "Number of garbage collections since the process started. Only available for .NET 8. and .NET Framework."),
            new("process.runtime.dotnet.gc.heap.size", upDownCounter, "Heap size, as observed during the last garbage collection. Only available for .NET 8."),
            new("process.runtime.dotnet.gc.heap.fragmentation.size", upDownCounter, "Heap fragmentation, as observed during the last garbage collection. Only available for .NET 8."),
            new("process.runtime.dotnet.gc.objects.size", upDownCounter, "Count of bytes currently in use by live objects in the GC heap. Only available for .NET 8. and .NET Framework."),
            new("process.runtime.dotnet.gc.allocations.size", counter, "Count of bytes allocated on the managed GC heap since the process started. Only available for .NET 8."),
            new("process.runtime.dotnet.gc.committed_memory.size", upDownCounter, "Amount of committed virtual memory for the managed GC heap, as observed during the last garbage collection. Only available for .NET 8."),
            new("process.runtime.dotnet.gc.duration", counter, "The total amount of time paused in GC since the process start. Only available for .NET 8."),
            new("process.runtime.dotnet.monitor.lock_contention.count", counter, "Contentions count when trying to acquire a monitor lock since the process started. Only available for .NET 8. and .NET Framework."),
            new("process.runtime.dotnet.thread_pool.threads.count", counter, "Number of thread pool threads, as observed during the last measurement. Only available for .NET 8."),
            new("process.runtime.dotnet.thread_pool.completed_items.count", counter, "Number of work items processed by the thread pool since the process started. Only available for .NET 8."),
            new("process.runtime.dotnet.thread_pool.queue.length", upDownCounter, "Number of work items currently queued for processing by the thread pool. Only available for .NET 8."),
            new("process.runtime.dotnet.jit.il_compiled.size", counter, "Bytes of intermediate language that have been compiled since the process started. Only available for .NET 8."),
            new("process.runtime.dotnet.jit.methods_compiled.count", counter, "Number of times the JIT compiler compiled a method since the process started. Only available for .NET 8."),
            new("process.runtime.dotnet.jit.compilation_time", counter, "Amount of time the compiler spent compiling methods since the process started. Only available for .NET 8."),
            new("process.runtime.dotnet.timer.count", upDownCounter, "Number of timer instances currently active. Only available for .NET 8."),
            new("process.runtime.dotnet.assemblies.count", upDownCounter, "Number of .NET assemblies that are currently loaded. Only available for .NET 8. and .NET Framework."),
            new("process.runtime.dotnet.exceptions.count", counter, "Count of exceptions thrown in managed code since the observation started. Only available for .NET 8. and .NET Framework."),
        };
