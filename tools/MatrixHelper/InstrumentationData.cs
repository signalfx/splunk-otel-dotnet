...
internal static class InstrumentationData
{
    public static Instrumentation[] GetInstrumentations()
    {
        ...
        const string conditionallyBundled = "APM bundled, if data points for the metric contain `telemetry.sdk.language` attribute with a value of `dotnet`.";
        const string bundled = "APM bundled.";
        ...
        {
            new("http.server.request.duration", histogram, "Duration of the inbound HTTP request.", bundled),
        ...
        {
            new("http.client.request.duration", histogram, "Duration of HTTP client requests.", bundled),
