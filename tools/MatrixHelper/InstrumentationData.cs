...
internal static class InstrumentationData
{
    public static Instrumentation[] GetInstrumentations()
    {
        ...
        var instrumentations = new Instrumentation[]
        {
            ...
            new(["MONGODB"], [new InstrumentedComponent("MongoDB.Driver.Core / MongoDB.Driver", "2.7.0 and higher")], "Not supported on .NET Framework", "beta", "third-party", [], [new TracesList()], []),
