...
internal static class ResourceDetectorsData
{
    public static ResourceDetector[] GetResourceDetectors()
    {
        return new ResourceDetector[]
        {
            ...
            new("HOST", "Host detector.", new Attribute[] { new("host.id"), new("host.name") }, "alpha", "community", new Dependency("Host Resource Detectors", "https://github.com/open-telemetry/opentelemetry-dotnet-contrib/tree/main/src/OpenTelemetry.Resources.Host", "https://www.nuget.org/packages/OpenTelemetry.Resources.Host", "0.1.0-beta.3", "beta")),
            new("OPERATINGSYSTEM", "Operating System detector.", new Attribute[] { new("os.type"), new("os.build_id"), new("os.description"), new("os.name"), new("os.version") }, "beta", "community", new Dependency("Operating System Detectors", "https://github.com/open-telemetry/opentelemetry-dotnet-contrib/blob/main/src/OpenTelemetry.Resources.OperatingSystem", "https://www.nuget.org/packages/OpenTelemetry.Resources.OperatingSystem", "0.1.0-alpha.4", "alpha")),
            new("PROCESS", "Process detector.", new Attribute[] { new("process.owner"), new("process.pid") }, "alpha", "community", new Dependency("Process Resource Detectors", "https://github.com/open-telemetry/opentelemetry-dotnet-contrib/tree/main/src/OpenTelemetry.Resources.Process", "https://www.nuget.org/packages/OpenTelemetry.Resources.Process", "0.1.0-beta.3", "beta")),
