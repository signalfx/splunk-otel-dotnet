...
internal static class ResourceDetectorsData
{
    public static ResourceDetector[] GetResourceDetectors()
    {
        return new ResourceDetector[]
        {
            ...
            new("HOST", "Host detector.", new Attribute[] { new("host.id"), new("host.name") }, "alpha", "community", new Dependency("Host Resource Detectors", "https://github.com/open-telemetry/opentelemetry-dotnet-contrib/tree/main/src/OpenTelemetry.Resources.Host", "https://www.nuget.org/packages/OpenTelemetry.Resources.Host", "1.12.0-beta.1", "beta")),
