...
See [Open Telemetry Auto Instrumentation documentation](https://github.com/open-telemetry/opentelemetry-dotnet-instrumentation/blob/v1.16.0/docs/config.md)
...
1. Set the [resources](https://github.com/open-telemetry/opentelemetry-dotnet-instrumentation/blob/v1.16.0/docs/config.md#resources).
...
> Some settings can be omitted on .NET. For more information, see the [documentation](https://github.com/open-telemetry/opentelemetry-dotnet-instrumentation/blob/v1.16.0/docs/config.md#net-clr-profiler).
...
- [1]: By default, instrumentation libraries are configured to send to a local
  ...
  precedence.
- [2]: Enabling remote configuration initializes the continuous profiling
  pipeline and can add overhead even while profiling is disabled. See
  [OpAMP runtime behavior](opamp-config.md#runtime-behavior).
