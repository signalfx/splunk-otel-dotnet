// <copyright file="OtelLogging.cs" company="Splunk Inc.">
...
{
    private const string LogDirectoryKey = "OTEL_DOTNET_AUTO_LOG_DIRECTORY";
    ...
    private static string? GetLogDirectory()
    {
        ...
        try
        {
            logDirectory = Environment.GetEnvironmentVariable(LogDirectoryKey);
