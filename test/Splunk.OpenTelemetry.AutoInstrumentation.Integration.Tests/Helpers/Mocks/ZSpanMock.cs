// <copyright file="ZSpanMock.cs" company="Splunk Inc.">
...
#if NETFRAMEWORK
using Splunk.OpenTelemetry.AutoInstrumentation.Integration.Tests.Helpers.Compatibility;
#endif

namespace Splunk.OpenTelemetry.AutoInstrumentation.Integration.Tests.Helpers.Mocks;
